...
public interface glTexCoordP2uiv {

/**
 * Unsafe version of: {@link #glTexCoordP2uiv TexCoordP2uiv}
 */
    public void nglTexCoordP2uiv(int type, long coords);
 ...
 */
    public void glTexCoordP2uiv(@NativeType("GLenum") int type, @NativeType("GLuint const *") IntBuffer coords);
 ...
 * @see <a href="https://docs.gl/gl3/glTexCoord">Reference Page</a> - <em>This function is deprecated and unavailable in the Core profile</em>
 */
    public void glTexCoordP2uiv(@NativeType("GLenum") int type, @NativeType("GLuint const *") int[] coords);
