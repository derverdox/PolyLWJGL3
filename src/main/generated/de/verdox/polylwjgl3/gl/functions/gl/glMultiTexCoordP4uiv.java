...
public interface glMultiTexCoordP4uiv {

/**
 * Unsafe version of: {@link #glMultiTexCoordP4uiv MultiTexCoordP4uiv}
 */
    public void nglMultiTexCoordP4uiv(int texture, int type, long coords);
 ...
 */
    public void glMultiTexCoordP4uiv(@NativeType("GLenum") int texture, @NativeType("GLenum") int type, @NativeType("GLuint const *") IntBuffer coords);
 ...
 * @see <a href="https://docs.gl/gl3/glMultiTexCoord">Reference Page</a> - <em>This function is deprecated and unavailable in the Core profile</em>
 */
    public void glMultiTexCoordP4uiv(@NativeType("GLenum") int texture, @NativeType("GLenum") int type, @NativeType("GLuint const *") int[] coords);
