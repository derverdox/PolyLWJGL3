 ...
 */
    public void glVertexAttrib3sv(@NativeType("GLuint") int index, @NativeType("GLshort const *") ShortBuffer v);
 ...
 * @see <a href="https://docs.gl/gl4/glVertexAttrib">Reference Page</a>
 */
    public void glVertexAttrib3sv(@NativeType("GLuint") int index, @NativeType("GLshort const *") short[] v);
