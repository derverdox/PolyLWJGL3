...
public interface glMultiTexCoord3iv {

/**
 * Unsafe version of: {@link #glMultiTexCoord3iv MultiTexCoord3iv}
 */
    public void nglMultiTexCoord3iv(int texture, long v);
 ...
 */
    public void glMultiTexCoord3iv(@NativeType("GLenum") int texture, @NativeType("GLint const *") IntBuffer v);
 ...
 * @see <a href="https://docs.gl/gl3/glMultiTexCoord">Reference Page</a> - <em>This function is deprecated and unavailable in the Core profile</em>
 */
    public void glMultiTexCoord3iv(@NativeType("GLenum") int texture, @NativeType("GLint const *") int[] v);
