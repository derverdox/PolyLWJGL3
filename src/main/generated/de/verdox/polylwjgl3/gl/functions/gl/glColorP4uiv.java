...
public interface glColorP4uiv {

/**
 * Unsafe version of: {@link #glColorP4uiv ColorP4uiv}
 */
    public void nglColorP4uiv(int type, long color);
 ...
 */
    public void glColorP4uiv(@NativeType("GLenum") int type, @NativeType("GLuint const *") IntBuffer color);
 ...
 * @see <a href="https://docs.gl/gl3/glColor">Reference Page</a> - <em>This function is deprecated and unavailable in the Core profile</em>
 */
    public void glColorP4uiv(@NativeType("GLenum") int type, @NativeType("GLuint const *") int[] color);
