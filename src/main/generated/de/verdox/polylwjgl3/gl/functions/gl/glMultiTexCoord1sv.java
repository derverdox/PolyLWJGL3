...
public interface glMultiTexCoord1sv {

/**
 * Unsafe version of: {@link #glMultiTexCoord1sv MultiTexCoord1sv}
 */
    public void nglMultiTexCoord1sv(int texture, long v);
 ...
 */
    public void glMultiTexCoord1sv(@NativeType("GLenum") int texture, @NativeType("GLshort const *") ShortBuffer v);
 ...
 * @see <a href="https://docs.gl/gl3/glMultiTexCoord">Reference Page</a> - <em>This function is deprecated and unavailable in the Core profile</em>
 */
    public void glMultiTexCoord1sv(@NativeType("GLenum") int texture, @NativeType("GLshort const *") short[] v);
